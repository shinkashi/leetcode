...
var NTI1885229 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
var NTI1852036 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
var NTI1194641 = {size: 0, kind: 17, base: null, node: null, finalizer: null};
var NTI1852011 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NTI1865011 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NTI1852019 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NNI1852019 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI1188044, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI1188044, name: "Field1", sons: null}]};
NTI1852019.node = NNI1852019;
...
var NNI1865011 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a", len: 0, typ: NTI1188044, name: "a", sons: null}, 
{kind: 1, offset: "b", len: 0, typ: NTI1188044, name: "b", sons: null}]};
NTI1865011.node = NNI1865011;
...
var NNI1852011 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI1188044, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI1188044, name: "Field1", sons: null}]};
NTI1852011.node = NNI1852011;
var NNI1194641 = {kind: 2, len: 0, offset: 0, typ: null, name: null, sons: []};
NTI1194641.node = NNI1194641;
NTI1194641.base = NTI1194619;
NTI1852036.base = NTI1852011;
NTI1885229.base = NTI1188015;
function setConstr() {
        var result = {};
...
function contains_1865057(s_1865063, value_1865064) {
  var result_1865065 = false;

    result_1865065 = ((s_1865063.a <= value_1865064) && (value_1865064 <= s_1865063.b));

  return result_1865065;

}
function HEX2EHEX2E_1865001(a_1865006, b_1865008) {
  var result_1865014 = ({a: 0, b: 0});

    nimCopy(result_1865014, {a: a_1865006, b: b_1865008}, NTI1865011);

  return result_1865014;
...
function findMissingRanges(nums_1852005, lower_1852006, upper_1852007) {
            function remove_1852033(val_1852035) {
                var newIntervals_1852037 = [];
                L1: do {
                  var iv_1860214 = null;
                  var i_1890082 = 0;
                  var L_1890083 = (intervals_1852032).length;
                  L2: do {
                      L3: while (true) {
                      if (!(i_1890082 < L_1890083)) break L3;
                        iv_1860214 = intervals_1852032[chckIndx(i_1890082, 0, (intervals_1852032).length-1)];
                        if (contains_1865057(HEX2EHEX2E_1865001(iv_1860214.Field0, iv_1860214.Field1), val_1852035)) {
                        if (!((val_1852035 == iv_1860214.Field0))) {
                        newIntervals_1852037.push({Field0: iv_1860214.Field0, Field1: subInt(val_1852035, 1)});;
                        }
                        
                        if (!((val_1852035 == iv_1860214.Field1))) {
                        newIntervals_1852037.push({Field0: addInt(val_1852035, 1), Field1: iv_1860214.Field1});;
                        }
                        
                        }
                        else {
                          var Tmp4 = nimCopy(null, iv_1860214, NTI1852011);
                        newIntervals_1852037.push(Tmp4);;
                        }
                        
                        i_1890082 = addInt(i_1890082, 1);
                        if (!(((intervals_1852032).length == L_1890083))) {
                ...
                intervals_1852032 = nimCopy(null, newIntervals_1852037, NTI1852036);
  ...
  var result_1852009 = [];
    ...
    var intervals_1852032 = [nimCopy(null, {Field0: lower_1852006, Field1: upper_1852007}, NTI1852019)];
    L1: do {
      var n_1885214 = null;
      var n_1885214_Idx = 0;
      var i_1890086 = 0;
      var L_1890087 = (nums_1852005).length;
      L2: do {
          L3: while (true) {
          if (!(i_1890086 < L_1890087)) break L3;
            n_1885214 = nums_1852005; n_1885214_Idx = chckIndx(i_1890086, 0, (nums_1852005).length-1);
            remove_1852033(n_1885214[n_1885214_Idx]);
            i_1890086 = addInt(i_1890086, 1);
            if (!(((nums_1852005).length == L_1890087))) {
            failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    result_1852009 = nimCopy(null, [], NTI1885229);
    L4: do {
      var iv_1885237 = null;
      var i_1890090 = 0;
      var L_1890091 = (intervals_1852032).length;
      L5: do {
          L6: while (true) {
          if (!(i_1890090 < L_1890091)) break L6;
            iv_1885237 = intervals_1852032[chckIndx(i_1890090, 0, (intervals_1852032).length-1)];
            if (!((iv_1885237.Field0 == iv_1885237.Field1))) {
            var s_1890001 = (cstrToNimstr((iv_1885237.Field0)+"") || []).concat(makeNimstrLit("->") || [],cstrToNimstr((iv_1885237.Field1)+"") || []);
            result_1852009.push(toJSStr(s_1890001));;
            }
            else {
              var s_1890011 = cstrToNimstr((iv_1885237.Field0)+"");
              result_1852009.push(toJSStr(s_1890011));;
            }
            
            i_1890090 = addInt(i_1890090, 1);
            if (!(((intervals_1852032).length == L_1890091))) {
            failedAssertImpl_1305480(makeNimstrLit("iterators.nim(204, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
